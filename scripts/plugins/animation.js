(function() {
    FX.plugins["animation"] = (function(id, option) {
        ...
        function fade(demo, type, playDelay, playTime) {
            ...
            demo.animate({ opacity: desOpacity }, {
        ...
        function slideTo(demo, data, direction, playDelay, playTime) {
            switch (direction) {
                case "bottom": //自底部
                    ...
                    demo.animate({ top: data.itemTop + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "left": //自左侧
                    ...
                    demo.animate({ left: data.itemLeft + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "leftBottom": //自左下部
                    demo[0].style.left = "-" + data.spaceW + 'px';
                    demo[0].style.top = data.winH + 'px';
                    demo.animate({ left: data.itemLeft + "px", top: data.itemTop + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
        ...
        function slideFrom(demo, data, direction, playDelay, playTime) {
            switch (direction) {
                case "bottom": //向底部
                    demo[0].style.top = data.itemTop + 'px';
                    demo.animate({ top: data.winH + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    ...
                    break;
                case "left": //向左侧
                    demo[0].style.left = data.itemLeft + 'px';
                    demo.animate({ left: "-" + data.spaceW + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "right": //向右侧
                    demo[0].style.left = data.itemLeft + 'px';
                    demo.animate({ left: data.winW + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "top": //向顶部
                    demo[0].style.top = data.itemTop + 'px';
                    demo.animate({ top: "-" + data.spaceH + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "leftBottom": //向左下部
                    demo[0].style.left = data.itemLeft + 'px';
                    demo[0].style.top = data.itemTop + 'px';
                    demo.animate({ left: "-" + data.spaceW + "px", top: data.winH + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "rightBottom": //向右下部
                    ...
                    demo[0].style.top = data.itemTop + 'px';
                    //+5像素防止出现边界线
                    demo.animate({ left: data.winW + "px", top: (document.body.clientHeight + 5) + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "leftTop": //向左上部
                    demo[0].style.left = data.itemLeft + 'px';
                    demo[0].style.top = data.itemTop + 'px';
                    demo.animate({ left: "-" + data.spaceW + "px", top: "-" + (data.spaceH + 5) + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "rightTop": //向右上部
                    demo[0].style.left = data.itemLeft + 'px';
                    demo[0].style.top = data.itemTop + 'px';
                    demo.animate({ left: data.winW + "px", top: "-" + (data.spaceH + 5) + "px" }, {
                        duration: playTime * timePlus,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
        ...
        function backTo(demo, data, direction, playDelay, playTime) {
            ...
            switch (direction) {
                case "bottom": //自底部
                    demo[0].style.top = data.winH + 'px';
                    demo.animate({ top: data.itemTop + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ top: data.itemTop + backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ top: data.itemTop + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    });
                ...
                case "left": //自左侧
                    demo[0].style.left = "-" + data.spaceW + 'px';
                    demo.animate({ left: data.itemLeft + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ left: data.itemLeft - backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ left: data.itemLeft + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "rightBottom": //自右下部
                    demo[0].style.left = data.winW + 'px';
                    demo[0].style.top = data.winH + 'px';
                    demo.animate({ left: data.itemLeft + "px", top: data.itemTop + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ left: data.itemLeft + backLength + "px", top: data.itemTop + backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ left: data.itemLeft + "px", top: data.itemTop + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
        ...
        function backFrom(demo, data, direction, playDelay, playTime) {
            ...
            switch (direction) {
                case "bottom": //向底部
                    demo.animate({ top: data.winH + "px" }, { duration: playTime * timePlus, easing: 'swing', queue: "x1" }).animate({ top: data.winH - backLength + "px" }, { duration: playTime * timePlus / 2, easing: 'swing', queue: "x1" }).animate({ top: data.winH + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: 'swing',
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    ...
                    break;
                case "left": //向左侧
                    demo.animate({ left: "-" + data.spaceW + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ left: backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ left: "-" + data.spaceW + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    ...
                    break;
                case "right": //向右侧
                    demo.animate({ left: data.winW + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ left: data.winW - backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ left: data.winW + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    ...
                    break;
                case "top": //向顶部
                    demo.animate({ top: "-" + data.spaceH + "px" }, { duration: playTime * timePlus, easing: "linear", queue: "x1" }).animate({ top: backLength + "px" }, { duration: playTime * timePlus / 2, easing: "linear", queue: "x1" }).animate({ top: "-" + data.spaceH + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "linear",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                ...
                case "leftBottom": //向左下部
                    ...
                    demo.animate({ left: "-" + data.spaceW + "px", top: document.body.clientHeight + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    ...
                    break;
                case "rightBottom": //向右下部
                    demo.animate({ left: data.winW + "px", top: data.winH + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ left: data.winW - backLength + "px", top: data.winH - backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ left: data.winW + "px", top: data.winH + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    ...
                    break;
                case "leftTop": //向左上部
                    demo.animate({ left: "-" + data.spaceW + "px", top: "-" + data.spaceH + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ left: backLength + "px", top: backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ left: "-" + data.spaceW + "px", top: "-" + data.spaceH + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
                    ...
                    break;
                case "rightTop": //向右上部
                    demo.animate({ left: data.winW + "px", top: "-" + data.spaceH + "px" }, { duration: playTime * timePlus, easing: "swing", queue: "x1" }).animate({ left: data.winW - backLength + "px", top: backLength + "px" }, { duration: playTime * timePlus / 2, easing: "swing", queue: "x1" }).animate({ left: data.winW + "px", top: "-" + data.spaceH + "px" }, {
                        duration: playTime * timePlus / 2,
                        easing: "swing",
                        queue: "x1",
                        callback: PlayInteractiveInAnimation(demo)
        ...
        function pop(demo, data, type, playDelay, playTime) {
            ...
            if (type.search("toAppearance") !== -1) {
                ...
                demo.animate({ left: "+=" + offl1 + "px", top: "+=" + offt1 + "px", width: w1 + "px", height: h1 + "px", overflow: 'visible' }, { duration: (playTime / 3) * timePlus, easing: "swing", queue: "x1", step: function() { demo.css("overflow", "visible"); } });
                demo.animate({ left: "+=" + offl2 + "px", top: "+=" + offt2 + "px", width: w2 + "px", height: h2 + "px" }, { duration: (playTime / 3) * timePlus, easing: "swing", queue: "x1", step: function() { demo.css("overflow", "visible"); } });
                demo.animate({ left: "+=" + offl3 + "px", top: "+=" + offt3 + "px", width: w3 + "px", height: h3 + "px" }, {
                    duration: (playTime / 3) * timePlus,
                    easing: "swing",
                    queue: "x1",
                    step: function() { demo.css("overflow", "visible"); },
                    callback: PlayInteractiveInAnimation(demo)
                });
            } else if (type.search("fromAppearance") !== -1) {
                w = data.spaceW;
                ...
                offl3 = -data.spaceW / 2;
                offt3 = -data.spaceH / 2;
                demo.animate({ left: "+=" + offl1 + "px", top: "+=" + offt1 + "px", width: w1 + "px", height: h1 + "px", overflow: 'visible' }, { duration: (playTime / 2) * timePlus, easing: "swing", queue: "x1", step: function() { demo.css("overflow", "visible"); } });
                demo.animate({ left: "+=" + offl2 + "px", top: "+=" + offt2 + "px", width: w2 + "px", height: h2 + "px", opacity: 0.0 }, {
                    duration: (playTime / 2) * timePlus,
                    easing: "swing",
                    queue: "x1",
                    step: function() { demo.css("overflow", "visible"); },
                    callback: PlayInteractiveInAnimation(demo)
        ...
        function flip(demo, data, type, playDelay, playTime) {
            ...
            demo.animate({ left: l + "px", top: t + "px", width: w + "px", height: h + "px" }, {
                duration: playTime * timePlus / 3,
                easing: "linear",
                queue: "x1",
                callback: PlayInteractiveInAnimation(demo)
            });
